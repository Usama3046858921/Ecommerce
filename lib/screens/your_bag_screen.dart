...
class YOurBagScreen extends StatefulWidget {
  ...
  @override
  State<YOurBagScreen> createState() => _YOurBagState();
}

class _YOurBagState extends State<YOurBagScreen> {
  @override
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: btnWidget(context: context, clr: appColors.baseDarkPinkColor, txt: 'Check Out', fn:()=> PageRouting().goToNextPage(context, SignUpScreen())
              ...
              children: [
                Expanded(
                  child: DropDownButtonWidget(
                      txt: 'Size', itm: const ["M", "L", "S", "ML"]),
                ),
                Expanded(
                  child: DropDownButtonWidget(
                      txt: 'Color', itm: const ["RED", "BLACK", "WHITE", "BROWN"]),
                ),
                Expanded(
                  child: DropDownButtonWidget(
                      txt: 'Quantity', itm: const ["1", "2", "3", "4", "5"]),
                ),
              ],
            ),
          )
